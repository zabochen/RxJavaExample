...
class ClickListenerFragment : Fragment(), AnkoLogger {
    ...
    @BindView(R.id.fragmentViewListener_editText)
    lateinit var mEditText: EditText

    @BindView(R.id.fragmentViewListener_buttonNative)
    lateinit var mButtonNative: Button

    @BindView(R.id.fragmentViewListener_buttonRx)
    lateinit var mButtonRx: Button

    @BindView(R.id.fragmentViewListener_textView)
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        val view: View = inflater.inflate(R.layout.fragment_view_listener, container, false)
